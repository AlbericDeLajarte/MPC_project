classdef MPC_Control_y < MPC_Control
  ...
  methods
    ...
    function ctrl_opt = setup_controller(mpc)
      ...
      N = 20;  %aka 8sec /Ts, sachant que l'énoncé veut qu'on prenne 8 secondes pour remettre à l'origine le drone écarté de 2m sur x ou y
