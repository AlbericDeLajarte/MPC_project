classdef Quad
    ...
    methods
       ...
       function ref_step = MPC_ref_step(quad, t, ref_time)
        ...
        function [ctrl, traj] = ctrl_NMPC(quad)
            ...
            vec_ref = [ 0 0 0 0 0 REF(4) 0 0 0 REF(1) REF(2) REF(3)];
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%
            ctrl = @(x,ref) quad.eval_ctrl(x, ref, opti, X0, REF, X, U);
            
        end
        
        function u = eval_ctrl(quad, x, ref, opti, X0, REF, X, U)
